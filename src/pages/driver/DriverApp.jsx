          ...
          {availableOrders.length === 0 ? (
            ...
            <Card key={o.id}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                >✕ Татгалзах</button>
                <button
                  style={{ flex: 1, padding: 11, borderRadius: 10, fontSize: 13, fontWeight: 700, border: 'none', background: '#1D9E75', color: '#fff', cursor: 'pointer', fontFamily: 'inherit' }}
            ...
            <>
              ...
              {activeOrder.status === 'arrived_dropoff' && (
                <Card>
                  ...
                  />
                  {proofFile && (
                    <div style={{ fontSize: 12, color: '#1D9E75', marginBottom: 8 }}>✓ {proofFile.name}</div>
                  )}
                </Card>
              )}
              ...
              {NEXT_STATUS[activeOrder.status] && (
                <Btn
                  variant={activeOrder.status === 'arrived_dropoff' ? 'green' : 'blue'}
              ...
              {activeOrder.note && (
                <Alert variant="amber" style={{ marginTop: 8 }}>
                  📝 {activeOrder.note}
                </Alert>
              )}
            </>
        ...
        <div style={{ padding: '14px 14px 0' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 10 }}>
            {[
              ...
              <div key={s.label} style={{ background: '#F9FAFB', borderRadius: 10, padding: '12px', border: '1px solid rgba(0,0,0,0.06)' }}>
      ...
      <>
        ...
        <div style={{ padding: '14px 14px 0' }}>
          <Card style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 17, fontWeight: 800 }}>{driverProfile?.name || 'Нэр байхгүй'}</div>
